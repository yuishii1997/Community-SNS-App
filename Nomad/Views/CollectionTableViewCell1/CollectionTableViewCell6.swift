//
//  CollectionTableViewCell6.swift
//  Nomad-App
//
...
public protocol CollectionTableViewCell6Delegate: class {
    func onCollectoinViewCell6DidSelect(tag: Int, indexPath: IndexPath)
}
class CollectionTableViewCell6: UITableViewCell,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout {
    
    public weak var cell6Delegate: CollectionTableViewCell6Delegate?
    
    static let identifier = "CollectionTableViewCell6"
    
    static func nib() -> UINib {
        return UINib(nibName: "CollectionTableViewCell6", bundle: nil)
    }
    ...
    func configure6(with models: [PostData]) {
        self.postArray4 = models
    ...
    override func awakeFromNib() {
        ...
        collectionView.register(MyCollectionViewCell6.nib(), forCellWithReuseIdentifier: MyCollectionViewCell6.identifier)
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        if collectionView.tag == 6 {
            self.cell6Delegate?.onCollectoinViewCell6DidSelect(tag: 6, indexPath: indexPath)
    ...
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        ...
        if postArray4.count >= 5 {
            return 5
        }else{
            return postArray4.count
        }
        
    }
    
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: MyCollectionViewCell6.identifier, for: indexPath) as! MyCollectionViewCell6
        
        
        cell.configure6(with: postArray4[indexPath.row])
        return cell
