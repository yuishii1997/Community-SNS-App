//
//  CollectionTableViewCell5.swift
//  Nomad-App
//
...
public protocol CollectionTableViewCell5Delegate: class {
    func onCollectoinViewCell5DidSelect(tag: Int, indexPath: IndexPath)
}
class CollectionTableViewCell5: UITableViewCell,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout {
    
    public weak var cell5Delegate: CollectionTableViewCell5Delegate?
    
    static let identifier = "CollectionTableViewCell5"
    
    static func nib() -> UINib {
        return UINib(nibName: "CollectionTableViewCell5", bundle: nil)
    }
    ...
    func configure5(with models: [PostData]) {
        self.postArray3 = models
    ...
    override func awakeFromNib() {
        ...
        collectionView.register(MyCollectionViewCell5.nib(), forCellWithReuseIdentifier: MyCollectionViewCell5.identifier)
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        if collectionView.tag == 5 {
            self.cell5Delegate?.onCollectoinViewCell5DidSelect(tag: 5, indexPath: indexPath)
    ...
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        ...
        if postArray3.count >= 5 {
            return 5
        }else{
            return postArray3.count
        }
        
    }
    
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: MyCollectionViewCell5.identifier, for: indexPath) as! MyCollectionViewCell5
        
        
        cell.configure5(with: postArray3[indexPath.row])
        return cell
