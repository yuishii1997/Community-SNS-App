...
class MyCollectionViewCell12: UICollectionViewCell {
    ...
    static let identifier = "MyCollectionViewCell12"
    
    static func nib() -> UINib {
        return UINib(nibName: "MyCollectionViewCell12", bundle: nil)
    }
    ...
    public func configure12(with model: PostData) {
