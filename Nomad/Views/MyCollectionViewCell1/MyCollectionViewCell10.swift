...
class MyCollectionViewCell10: UICollectionViewCell {
    ...
    static let identifier = "MyCollectionViewCell10"
    
    static func nib() -> UINib {
        return UINib(nibName: "MyCollectionViewCell10", bundle: nil)
    }
    ...
    public func configure10(with model: PostData) {
