...
class MyCollectionViewCell7: UICollectionViewCell {
    ...
    static let identifier = "MyCollectionViewCell7"
    
    static func nib() -> UINib {
        return UINib(nibName: "MyCollectionViewCell7", bundle: nil)
    }
    ...
    public func configure7(with model: UserData) {
