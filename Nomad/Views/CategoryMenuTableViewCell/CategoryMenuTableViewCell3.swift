//
//  CategoryMenuTableViewCell3.swift
//  Nomad-App
//
//  Created by yuishii on 2021/02/04.
//  Copyright © 2021 Yu Ishii. All rights reserved.
//
// ChooseCategoryViewControllerで表示するカテゴリーのセル

import UIKit
import Firebase

class CategoryMenuTableViewCell3: UITableViewCell {
    ...
    @IBOutlet weak var iconView: UIView! {
        didSet {
            iconView.backgroundColor = UIColor.rgb(red: 229, green: 229, blue: 229)
            iconView.layer.cornerRadius = iconView.frame.height / 15
        }
    }
