...
class JoinViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, MFMailComposeViewControllerDelegate {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        self.navigationItem.title = "コメント"
                        ...
                        if ( self?.listener1 == nil ) {
                            ...
                            self?.listener1 = postsRef.addSnapshotListener() { [weak self] querySnapshot, error in
                                if let error = error {
                                    ...
                                    self?.postArray.sort { $0.joinedTime > $1.joinedTime }
                                    // クルクルストップ
    ...
    @objc func alertButton(_ sender: UIButton, forEvent event: UIEvent){
        ...
        let myAction_2 = UIAlertAction(title: "投稿を削除する", style: UIAlertAction.Style.destructive, handler: {
            (action: UIAlertAction!) in
            let alert: UIAlertController = UIAlertController(title: "本当にこの投稿を削除してよろしいでしょうか？", message: nil, preferredStyle:  UIAlertController.Style.alert)
    ...
    @objc func alertButton2(_ sender: UIButton, forEvent event: UIEvent){
        ...
        let myAction_2 = UIAlertAction(title: "投稿を非表示にする", style: UIAlertAction.Style.default, handler: {
            ...
            let alert: UIAlertController = UIAlertController(title: "よろしいですか？", message: "この投稿を非表示にします。", preferredStyle:  UIAlertController.Style.alert)
        ...
        let myAction_3 = UIAlertAction(title: "ユーザーをブロックする", style: UIAlertAction.Style.default, handler: {
            ...
            let defaultAction: UIAlertAction = UIAlertAction(title: "はい", style: UIAlertAction.Style.destructive, handler:{
                ...
                if let myid = Auth.auth().currentUser?.uid {
                    ...
                    userRef2.updateData(["block": updateValue1])
                    userRef2.updateData(["block": updateValue2])
...
extension JoinViewController: GADUnifiedNativeAdLoaderDelegate {
