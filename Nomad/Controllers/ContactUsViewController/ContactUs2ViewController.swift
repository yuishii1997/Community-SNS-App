//
//  ContactUs2ViewController.swift
//  Nomad-App
//
...
class ContactUs2ViewController: UIViewController, UITextViewDelegate{
    
    var targetUid: String = "" //通報する対象のuid
    
    var targetId: String = "" //対象のドキュメントID
    ...
    @IBAction func saveButton(_ sender: Any) {
        ...
        if Auth.auth().currentUser != nil {
            ...
            if self.targetUid == "" {
                ...
                // 通報する対象のドキュメントID(targetId)がない場合
                ...
                // 通報する対象のドキュメントID(targetId)がある場合
