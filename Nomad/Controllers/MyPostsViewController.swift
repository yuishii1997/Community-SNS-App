...
class MyPostsViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    @IBAction func menu(_ sender: Any) {
        let myAlert = UIAlertController(title: "投稿を全て削除しますか？", message: nil, preferredStyle: UIAlertController.Style.actionSheet)
        // アクションを生成.
        let myAction_1 = UIAlertAction(title: "全て削除する", style: UIAlertAction.Style.destructive, handler: {
            (action: UIAlertAction!) in
            
            let alert: UIAlertController = UIAlertController(title: "よろしいですか？", message: "あなたの投稿がすべて削除されます。", preferredStyle:  UIAlertController.Style.alert)
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if self.posts == "notExist" {
            ...
            cell.label1.text = "まだ投稿をしていません"
            cell.label2.text = "投稿をするとここに表示されます。"
...
extension MyPostsViewController: GADUnifiedNativeAdLoaderDelegate {
